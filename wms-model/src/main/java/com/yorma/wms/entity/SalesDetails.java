...
public class SalesDetails {
	...
	private static final long serialVersionUID = -2964306486199991521L;
	...
	public String toString() {
		return "SalesDetails [id=" + id + ", orderSo=" + orderSo + ", so=" + so + ", goodsUuid=" + goodsUuid
